...
export default {
  ...
  setup() {
    ...
    // Hardcoded nav order is intentional — keeps sidebar presentation
    // independent of route declaration order in main.js
    const navItems = [
...
.app-main {
  ...
  /* min-width: 0 prevents the flex/grid child from overflowing its column when tables are wide */
  min-width: 0;
}
